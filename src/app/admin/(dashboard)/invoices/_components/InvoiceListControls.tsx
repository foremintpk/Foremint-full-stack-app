...
export function InvoiceListControls({ filters }: InvoiceListControlsProps) {
  ...
  const updateQuery = (updates: Record<string, string | undefined>) => {
    startTransition(() => {
      ...
      router.push(`/admin/invoices?${params.toString()}` as any);
    });
  };
    ...
    >
      ...
      <div className="relative flex-1 max-w-lg">
        ...
        <input
          ...
          className="block w-full h-10 pl-11 pr-4 bg-white border border-[#e0d9f7] rounded-full text-sm text-[#111111] placeholder-[#9ca3af] outline-none focus:border-[#34088f] focus:ring-2 focus:ring-[#34088f]/20 transition-all"
        />
      </div>
