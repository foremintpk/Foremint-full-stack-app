  ...
  return (
    <div className="w-full space-y-8 animate-pulse p-6">
      ...
      <div className="w-full border border-[#e0d9f7] rounded-2xl overflow-hidden bg-white shadow-[0_1px_4px_rgba(52,8,143,0.06)]">
        ...
        <div className="grid grid-cols-[1fr_1.5fr_1fr_1.2fr_1.2fr_0.6fr] gap-4 px-6 py-4 bg-[#f4f0fe] border-b border-[#e0d9f7]">
          {Array.from({ length: 6 }).map((_, idx) => (
            <div key={idx} className="h-3 bg-gray-250 rounded-full w-3/4" />
          ))}
        </div>
        ...
        <div className="divide-y divide-[#e0d9f7]">
          {Array.from({ length: 8 }).map((_, rIdx) => (
            <div
              key={rIdx}
              className="grid grid-cols-[1fr_1.5fr_1fr_1.2fr_1.2fr_0.6fr] gap-4 px-6 py-5 bg-white items-center"
            >
              ...
              <div className="h-4 bg-gray-250 rounded-full w-24" />
              <div className="h-4 bg-gray-250 rounded-full w-20" />
