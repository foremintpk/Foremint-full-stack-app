/**
 * @file src/app/admin/(dashboard)/users/_components/UserPagination.tsx
 * @description Interactive Client Component for page navigation, preserving filter query params.
 */
...
export function UserPagination({
  ...
  currentPage,
  pageSize,
}: UserPaginationProps): React.JSX.Element | null {
  ...
  return (
    <nav
      ...
      className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4 px-5 bg-white border border-[#e0d9f7] rounded-2xl shadow-[0_1px_4px_rgba(52,8,143,0.06)] font-inter"
    >
      <div className="text-xs text-gray-500 font-inter font-semibold">
        Showing <span className="font-bold text-gray-900">{startOffset}</span>–
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          ...
          className="px-4 py-2 text-xs font-bold text-gray-700 bg-gray-100 hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 rounded-full flex items-center gap-1.5"
        >
