            ...
            <td style="background:#fffbeb;padding:14px 40px;border-bottom:1px solid #fde68a;">
              <table cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  ...
                  <td>
                    <p style="margin:0;font-size:13px;font-weight:600;color:#92400e;">New LLC Order Received — Action Required</p>
                  </td>
                </tr>
              </table>
            </td>
                  ...
                  <td style="padding:4px 24px;">
                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                      <tr>
                        ...
                        <td style="font-size:12px;font-weight:600;color:#374151;text-align:right;padding:10px 0;border-bottom:1px solid #f3f4f6;font-family:'SF Mono',Menlo,monospace;">#${orderRef}</td>
                      </tr>
                      <tr>
                        <td style="font-size:13px;color:#9ca3af;padding:10px 0;border-bottom:1px solid #f3f4f6;">Submitted</td>
                        <td style="font-size:13px;font-weight:500;color:#374151;text-align:right;padding:10px 0;border-bottom:1px solid #f3f4f6;">${orderDate}</td>
                      </tr>
                      ${businessName ? `
                      <tr>
                        <td style="font-size:13px;color:#9ca3af;padding:10px 0;border-bottom:1px solid #f3f4f6;">LLC Name</td>
                      ...
                      ${serviceName ? `
                      <tr>
                        <td style="font-size:13px;color:#9ca3af;padding:10px 0;border-bottom:1px solid #f3f4f6;">Service / Package</td>
                        <td style="font-size:13px;font-weight:500;color:#374151;text-align:right;padding:10px 0;border-bottom:1px solid #f3f4f6;">${serviceName}</td>
                      </tr>` : ''}
                      ${formationState ? `
                      <tr>
